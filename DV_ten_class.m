...
% The subprograme called by "DeePVP_e.m" and "DeePVP_calssification.m" for PVP classification. 
t=str2num(t);
...
cmd=['python ',pwd,'/predict.py ',pwd,'/model_10class/model.h5 ',pwd,'/',tmp];unix(cmd); % Make prediction based on the one-hot matrix.
...
% Calculate the final prediction based on the 10 predicted scores.
for i=1:1:size(data,1)
