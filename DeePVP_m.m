function DeePVP_m(SeqFile,ResultFile,option1,num1,option2,num2)
% The subprograme called by the "DeePVP.m" for the PVP identification.
if nargin==2
    t='0';
    b='5000'; % batch size
elseif nargin==3
...
while s<=seqnum
    ...
    %clear f
    DV_two_class([pwd,'/',tmp1,'file',num2str(c),'.faa'],[pwd,'/',tmp1,'out',num2str(c),'.csv'],t,tmp1); % PVP identification for each batch.
